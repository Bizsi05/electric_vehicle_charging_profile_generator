...
CHARGING_POWER_KW = 6.6   # konstans töltési teljesítmény [kW] (állítható paraméter)
YEAR=2021         # melyik év szimulációja
MARGINAL_SAMPLES = 50000  # hány minta a marginal ábrákhoz
EV_COUNT = 584 #Hány EV töltést szimulálunk összesen egy nap alatt
